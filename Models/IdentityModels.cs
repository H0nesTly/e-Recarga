...
namespace e_Recarga.Models
{
    ...
    /* public class ApplicationDbInitializer : DropCreateDatabaseAlways<ApplicationDbContext>
     {
         ...
         public static void InitializeIdentityForEF(ApplicationDbContext db)
         {
             ...
             const string sapassword = "sa@12345";

             const string aname = "admin@example.com";
             const string apassword = "a@12345";
             ...
             //reateUser(userManager, unname, unpassword, "", "", "", "", "", "", "", "", null, "", utilizadornomalrole);
         ...
         // private static ApplicationUser CreateUser(ApplicationUserManager userManager, string name, string password, string morada, string concelho, string freguesia, string codigopostal, string localidade, string telemovel, string telefone, string nif, DateTime? datanascimento, string pais, IdentityRole role)
    ...
    public class ApplicationDbInitializer : DropCreateDatabaseAlways<ApplicationDbContext>
    {
        ...
        public static void InitializeIdentityForEF(ApplicationDbContext db)
        {
            ...
            const string saname = "superadmin@example.com";
            const string sapassword = "Superadmin@123456";

            const string aname = "admin@example.com";
            const string apassword = "Admin@123456";

            const string normal1Name = "normal1@example.com";
            const string Normal1password = "Normal1@123456";
            ...
            //Create Role Normal, see the function bellow
            var normalrole = CreateRole(roleManager, "Normal");
            ...
            //Create Normal1 user 
            CreateUser(userManager, normal1Name, Normal1password, "", "", "", "", normalrole);
